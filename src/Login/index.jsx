...
//criar um arrow function pro Input
const Input = props =>(
  <input {...props}className="w-full bg-transparent p-4 border rounded-xl border-onix text-lg outline-none focus:border-platium"/>
)
        ...
        <div className="max-w-md flex-1">
          ...
          <form className="space-y-6" onSubmit={formik.handleSubmit}>
            ...
            <button 
              ...
              // vamos fazer outra condição aqui pra evitar que clicamos duas vezes no botão entrar
